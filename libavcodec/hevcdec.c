...
static void rpi_pred_sync_y(HEVCContext * const s)
{
}



static void rpi_pred_sync_c(HEVCContext * const s)
{
}
                                 ...
                                 const uint32_t code_exit, const uint32_t code_exit2)
{
    ...
    for(i = 0; i < n; i++) {
        ...
        q->code_exit = (i == 0) ? code_exit2 : code_exit;
    }
}
