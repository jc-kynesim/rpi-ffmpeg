...
#define mc_filter (rpi_shader + 1050)
#define mc_filter_b (rpi_shader + 1176)
#define mc_interrupt_exit12 (rpi_shader + 1304)
#define mc_exit1 (rpi_shader + 1342)
#define mc_end (rpi_shader + 1358)
