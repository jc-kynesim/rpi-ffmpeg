...
#define mc_filter_uv_b0 (rpi_shader + 326)
#define mc_filter_uv_b (rpi_shader + 506)
#define mc_exit (rpi_shader + 648)
#define mc_exit_c (rpi_shader + 648)
#define mc_setup (rpi_shader + 664)
#define mc_filter (rpi_shader + 948)
#define mc_filter_b (rpi_shader + 1068)
#define mc_interrupt_exit8c (rpi_shader + 1188)
