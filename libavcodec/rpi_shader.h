...
#define mc_filter (rpi_shader + 936)
#define mc_filter_b (rpi_shader + 1056)
#define mc_interrupt_exit12 (rpi_shader + 1178)
#define mc_exit1 (rpi_shader + 1216)
#define mc_end (rpi_shader + 1232)
